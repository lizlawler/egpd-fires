...
for params in "all-reg_nu" "xi-ri_nu" "sigma-ri_xi-ri_nu" "kappa-ri_xi-ri_nu"
do
...
nohup ./shell-scripts/miss-piggy/burn_sampling_mp.sh > full-model/output/${modname}_${dataset}_${params}_${sttime}.txt 2>&1 &
sleep 1
done
done

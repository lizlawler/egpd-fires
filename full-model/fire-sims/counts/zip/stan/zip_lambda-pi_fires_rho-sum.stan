...
parameters {
  ...
  real<lower = 0, upper = 1> rho1_lambda;
  real<lower = 0, upper = 1> rho_sum_lambda;
  ...
  real<lower = 0, upper = 1> rho1_pi;
  real<lower = 0, upper = 1> rho_sum_pi;
...
transformed parameters {
  ...
  real<lower = 0, upper = rho1_lambda> rho2_lambda = rho_sum_lambda - rho1_lambda;
  real<lower = 0, upper = rho1_pi> rho2_pi = rho_sum_pi - rho1_pi;
...
model {
  ...
  rho1_lambda ~ beta(4.5, 4);
  rho_sum_lambda ~ beta(5, 1.5);
  rho1_pi ~ beta(4.5, 4);
  rho_sum_pi ~ beta(5, 1.5);

...
saveRDS(egpd_fit, 
        file = paste0("./full-model/fire-sims/counts/zinb/stan-fits/zinb_byER_2000iter_YJ-X_logscores_", 
                      st_time, "_", end_time, ".RDS"))

MCMCtrace(egpd_fit, params = c("rho1_lambda", "rho2_lambda", "rho1_pi", "rho2_pi", "rho1_delta", "rho2_delta"),
          ind = TRUE,
          open_pdf = FALSE,
          filename = paste0('./full-model/figures/zinb/trace/zinb_fires_2000iter_byER_YJ-X_rhos_', st_time, "_", end_time, ".pdf"))

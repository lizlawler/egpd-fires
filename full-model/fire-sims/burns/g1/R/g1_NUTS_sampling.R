...
if(params == 'nu-reg_xi-reg') {
  ...
  MCMCtrace(egpd_fit, params = c("rho1_kappa", "rho2_kappa", "rho1_nu", "rho2_nu", "rho1_xi", "rho2_xi"),
            ind = TRUE,
            open_pdf = FALSE,
            filename = paste0('./full-model/figures/g1/trace/g1_kappa-ri_xi-ri_', suffix, '_rhos_',
                              st_time, "_", end_time, ".pdf"))
  MCMCtrace(egpd_fit, params = c("beta_nu"),
            ind = TRUE,
            open_pdf = FALSE,
            filename = paste0('./full-model/figures/g1/trace/g1_kappa-ri_xi-ri_', suffix, '_betas_',
                              st_time, "_", end_time, ".pdf"))
  MCMCtrace(egpd_fit, params = c("phi_nu"),
            ind = TRUE,
            open_pdf = FALSE,
            filename = paste0('./full-model/figures/g1/trace/g1_kappa-ri_xi-ri_', suffix, '_phis_',
                              st_time, "_", end_time, ".pdf"))
} else {
  MCMCtrace(egpd_fit, params = c("rho1_kappa", "rho2_kappa", "rho1_nu", "rho2_nu", "rho1_xi", "rho2_xi"),
            ind = TRUE,

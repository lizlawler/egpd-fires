...
# generate toy data
source("./sim-study/models/g1/R/g1_data_kappa-only.R")

# run sampling
egpd_init <- stan_model('./sim-study/models/g1/stan/g1_kappa-only.stan')
...
## ------
post <- rstan::extract(egpd_fit, pars = c("beta_kappa", "phi_kappa"))

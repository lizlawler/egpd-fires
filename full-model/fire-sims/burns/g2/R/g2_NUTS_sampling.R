...
egpd_model <- cmdstan_model(paste0('./full-model/fire-sims/burns/g2/stan/g2_', params, '.stan'), compile = TRUE, stanc_options = list("O1"))
egpd_fit <- egpd_model$sample(data = stan_data, 
                              ...
                              parallel_chains = 3,
                              init = 0.01,
                              output_dir = "full-model/fire-sims/burns/g2/csv-fits/")
...
MCMCtrace(egpd_stan_fit, params = "rho",
          ind = TRUE,
          open_pdf = FALSE,
          filename = paste0('./full-model/figures/g2/trace/g2_', params, '_', suffix, '_rhos_',
                            st_time, "_", end_time, ".pdf"))
MCMCtrace(egpd_stan_fit, params = "beta",
          ind = TRUE,
          open_pdf = FALSE,
          filename = paste0('./full-model/figures/g2/trace/g2_', params, '_', suffix,'_betas_',
                            st_time, "_", end_time, ".pdf"))
MCMCtrace(egpd_stan_fit, params = "phi",
          ind = TRUE,
          open_pdf = FALSE,
          filename = paste0('./full-model/figures/g2/trace/g2_', params, '_', suffix,'_phis_',
                            st_time, "_", end_time, ".pdf"))

...
parameters {
  ...
  array[C] vector<lower=0, upper=1>[2] rho; // 1 = nu, 2 = kappa, 3 = xi, 4 = gamma
}
transformed parameters {
  ...
  array[C] matrix[R, R] corr; // 1 = nu, 2 = kappa, 3 = xi, 4 = gamma
  ...
  kappa = exp(to_vector(ri_matrix[2][idx_train_er,]))[ii_tb_all];

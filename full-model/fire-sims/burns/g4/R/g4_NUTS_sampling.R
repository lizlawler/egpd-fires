...
saveRDS(egpd_stan_fit, 
        file = paste0("./full-model/fire-sims/burns/g4/stan-fits/g4_", params, suffix, 
...
MCMCtrace(egpd_stan_fit, params = "rho",
          ind = TRUE,
          open_pdf = FALSE,
          filename = paste0('./full-model/figures/g4/trace/g4_', params, '_', suffix, '_rhos_',
                            st_time, "_", end_time, ".pdf"))
MCMCtrace(egpd_stan_fit, params = "beta",
          ind = TRUE,
          open_pdf = FALSE,
          filename = paste0('./full-model/figures/g4/trace/g4_', params, '_', suffix,'_betas_',
                            st_time, "_", end_time, ".pdf"))
MCMCtrace(egpd_stan_fit, params = "phi",
          ind = TRUE,
          open_pdf = FALSE,
          filename = paste0('./full-model/figures/g4/trace/g4_', params, '_', suffix,'_phis_',
                            st_time, "_", end_time, ".pdf"))

...
ecoregion_summaries <- lapply(extractions, function(x) pivot_longer(x, !NA_L3NAME, names_to = "variable", values_to = "value")) %>% bind_rows %>%
  separate(variable, into = c("interval", "variable", "timestep"), sep = "_") %>%

...
# remove any uncorrected wind speed FWI tifs
tifs <- tifs[!grepl('uncorrected', tifs)]
...
# the above list of indices has one element per polygon, but we want one per L3 ecoregion

...
parameters {
  ...
  matrix[R, C-S] Z; // ordering: 1 = pi, 2 = delta, 3 = xi, 4 = theta
...
transformed parameters {
  ...
  for (s in 2:S) {
    for (r in 1:R) {
      ...
      reg[s-1][, r] = X_train_burn[r] * beta_burn[s-1][, r] + phi[s][idx_train_er, r] + gamma[s-1] * theta[r];
    }
  }
}
model {
...
generated quantities {
  ...
  for (s in 2:S) {
    for (r in 1:R) {
      reg_full[s-1][, r] = X_full_burn[r] * beta_burn[s-1][, r] + phi[s][, r] + gamma[s-1] * theta[r];
    }
  }

...
generated quantities {
  ...
  if (y_int < 50) {
    ...
    vector[N_tb_obs] kappa_train = exp(to_vector(ri_matrix[1]))[ii_tb_all][ii_tb_obs];
    ...
    vector[N_hold_obs] kappa_hold = exp(to_vector(ri_matrix[1]))[ii_hold_all][ii_hold_obs];

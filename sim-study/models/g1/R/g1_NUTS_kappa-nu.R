...
# generate toy data
source("./sim-study/models/g1/R/g1_data_kappa-nu.R")

# run sampling
egpd_init <- stan_model('./sim-study/models/g1/stan/g1_kappa-nu.stan')
...
saveRDS(egpd_fit, file = "./sim-study/models/g1/stan-fits/g1_kappa-nu.RDS")

MCMCtrace(egpd_fit, params = c("beta_kappa", "beta_nu", "phi_kappa", "phi_nu"),
          ind = TRUE,
          gvals = c(betas_kappa, betas_nu, phi_mat_kappa, phi_mat_nu),
          open_pdf = FALSE,
          filename = paste0('./sim-study/figures/g1/trace/g1_trace_kappa-nu_',

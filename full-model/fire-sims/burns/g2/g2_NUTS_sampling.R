...
egpd_fit <- egpd_model$sample(data = stan_data, 
                              ...
                              output_basename = paste0("g2_", suffix, "_", params, "_", st_time))

end_time <- format(as.POSIXlt(Sys.time(), "America/Denver"), "%H%M")

# save CmdStanMCMC object
file_name <- paste0("./full-model/fire-sims/burns/g2/cmd-stan-fits/g2_", 
...
MCMCtrace(egpd_mcmc, params = "rho",
          ind = TRUE,
          open_pdf = FALSE,
          filename = paste0('./full-model/figures/g2/trace/g2_', params, '_', 

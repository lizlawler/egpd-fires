...
truth_kappa
# ggsave(paste0('manuscript/scripts/toy_sim/g1/rep_summit/truth_kappa_', 
...
for(i in 1:r) {
  XB_kappa[i,] <- X_full[i, , ] %*% betas_kappa[, i]/3 + phi_mat[, i]/5
...
write_rds(toy_data_icarphi_st, 'manuscript/scripts/toy_sim/g1/data/toy_data_ar1_icarphi_spatial_time_t50.rds')

...
# run sampling of original model
...
saveRDS(egpd_fit, 
        file = paste0("./full-model/simulations/zip/stan-fits/zip_lambda-pi_fires_OG_396obs", 
                      st_time, "_", end_time, ".RDS"))

MCMCtrace(egpd_fit, params = c("rho1_lambda", "rho2_lambda", "rho1_pi", "rho2_pi"),
          ind = TRUE,
          open_pdf = FALSE,
          filename = paste0('./full-model/figures/zip/trace/zip_trace-lambda-pi_fires_OG_396obs', 
...
# run sampling of model with empirical zeroes
egpd_init <- stan_model('./full-model/simulations/zip/stan/zip_lambda-pi_fires_regional-zeroes.stan')
egpd_fit <- sampling(egpd_init, 
                     data = stan_data, 
                     iter = 1000,
                     chains = 3,
...
saveRDS(egpd_fit, 
        file = paste0("./full-model/simulations/zip/stan-fits/zip_lambda-pi_fires_396obs_reg-zeroes", 
                      st_time, "_", end_time, ".RDS"))

MCMCtrace(egpd_fit, params = c("rho1_lambda", "rho2_lambda"),
          ind = TRUE,
          open_pdf = FALSE,
          filename = paste0('./full-model/figures/zip/trace/zip_trace-lambda-pi_fires_396_reg-zeroes', 
                            st_time, "_", end_time, ".pdf"))
...
# run sampling of OG model with rho constraints written differently
egpd_init <- stan_model('./full-model/simulations/zip/stan/zip_lambda-pi_fires_rho-sum.stan')
egpd_fit <- sampling(egpd_init, 
                     data = stan_data, 
                     iter = 1000,
                     chains = 3,
...
saveRDS(egpd_fit, 
        file = paste0("./full-model/simulations/zip/stan-fits/zip_lambda-pi_fires_OG_396obs_rho-sum", 
                      st_time, "_", end_time, ".RDS"))

MCMCtrace(egpd_fit, params = c("rho1_lambda", "rho2_lambda"),
          ind = TRUE,
          open_pdf = FALSE,
          filename = paste0('./full-model/figures/zip/trace/zip_trace-lambda-pi_fires_OG_396_rho-sum', 
                            st_time, "_", end_time, ".pdf"))

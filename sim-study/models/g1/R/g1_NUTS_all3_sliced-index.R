...
load("~/Desktop/research/egpd-fires/sim-study/models/g1/data/toydata_g1_sliced-index_wksp.RData")

# run sampling
egpd_init <- stan_model('./sim-study/models/g1/stan/g1_all3_sliced-index.stan')
...
saveRDS(egpd_fit, file = "./sim-study/models/g1/stan-fits/g1_all3_sliced-index.RDS")

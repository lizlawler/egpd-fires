...
egpd_init <- stan_model('./full-model/fire-sims/burns/g1/stan/g1_fires_sliced-index.stan')
...
saveRDS(egpd_fit, 
        file = paste0("./full-model/fire-sims/burns/g1/stan-fits/g1_burns_sliced-index_logscore_", 
...
MCMCtrace(egpd_fit, params = c("rho1_kappa", "rho2_kappa", "rho1_nu", "rho2_nu", "rho1_xi", "rho2_xi"),
          ind = TRUE,
          open_pdf = FALSE,
          filename = paste0('./full-model/figures/g1/trace/g1_trace_burns_sliced-index_rhos_',
                            st_time, "_", end_time, ".pdf"))

MCMCtrace(egpd_fit, params = c("beta_kappa", "phi_kappa"),
          ind = TRUE,
          open_pdf = FALSE,
          filename = paste0('./full-model/figures/g1/trace/g1_trace_burns_sliced-index_KAPPA_',
                            st_time, "_", end_time, ".pdf"))

MCMCtrace(egpd_fit, params = c("beta_nu", "phi_nu"),
          ind = TRUE,
          open_pdf = FALSE,
          filename = paste0('./full-model/figures/g1/trace/g1_trace_burns_sliced-index_NU_',
                            st_time, "_", end_time, ".pdf"))

MCMCtrace(egpd_fit, params = c("beta_xi", "phi_xi"),
          ind = TRUE,
          open_pdf = FALSE,
          filename = paste0('./full-model/figures/g1/trace/g1_trace_burns_sliced-index_XI_',
                            st_time, "_", end_time, ".pdf"))

...
transformed data {
  ...
  // ordering: 1=lambda, 2=kappa, 3 = sigma, 4=pi, 5=delta, 6=xi
}
parameters {
  ...
  vector[2] gamma; // scaling parameter; 1 = kappa, 2 = sigma
}
transformed parameters {
  ...
  for (s in 2:S) {
    for (r in 1:R) {
      ...
      reg[s-1][, r] = X_train_burn[r] * beta_burn[s-1][, r] + phi[s][idx_train_er, r] + gamma[s-1] * theta[idx_train_er];
    }
  }
}
model {

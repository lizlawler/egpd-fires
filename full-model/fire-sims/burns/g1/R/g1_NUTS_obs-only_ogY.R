...
# run sampling
stan_data <- readRDS("./full-model/fire-sims/burns/data/burns_X-YJtrans_ogY.RDS")
...
MCMCtrace(egpd_fit, params = c("rho1_kappa", "rho2_kappa", "rho1_nu", "rho2_nu", "rho1_xi", "rho2_xi"),
          ind = TRUE,
          open_pdf = FALSE,
          filename = paste0('./full-model/figures/g1/trace/g1_trace_burns_obs-only_X-YJtrans_ogY_rhos_',
                            st_time, "_", end_time, ".pdf"))

MCMCtrace(egpd_fit, params = c("beta_kappa", "phi_kappa"),
          ind = TRUE,
          open_pdf = FALSE,
          filename = paste0('./full-model/figures/g1/trace/g1_trace_burns_obs-only_X-YJtrans_ogY_KAPPA_',
                            st_time, "_", end_time, ".pdf"))

MCMCtrace(egpd_fit, params = c("beta_nu", "phi_nu"),
          ind = TRUE,
          open_pdf = FALSE,
          filename = paste0('./full-model/figures/g1/trace/g1_trace_burns_obs-only_X-YJtrans_ogY_NU_',
                            st_time, "_", end_time, ".pdf"))

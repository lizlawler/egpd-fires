...
generated quantities {
  ...
  for (n in 1:N_hold_obs) {
    real kappa1_hold = exp(to_vector(reg_full[1][idx_hold_er,]))[ii_hold_all][ii_hold_obs][n];
    real kappa2_hold = exp(to_vector(reg_full[2][idx_hold_er,]))[ii_hold_all][ii_hold_obs][n];

...
generated quantities {
  ...
  for (n in 1:N_hold_obs) {
    real sigma_hold = exp(to_vector(reg_full[1][idx_hold_er,]))[ii_hold_all][ii_hold_obs][n];
    real kappa_hold = exp(to_vector(ri_matrix[1][idx_hold_er,]))[ii_hold_all][ii_hold_obs][n];

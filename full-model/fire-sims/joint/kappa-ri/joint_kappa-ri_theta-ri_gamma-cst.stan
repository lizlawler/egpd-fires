...
transformed data {
  ...
  // ordering: 1=lambda, 2=kappa, 3=pi, 4=delta, 5=kappa, 6=xi, 7=theta
}
parameters {
  array[N_tb_mis] real<lower=y_min> y_train_burn_mis;
  matrix[R, C-S] Z; // ordering: 1 = pi, 2 = delta, 3 = kappa, 4 = xi, 5=theta
  ...
  real gamma; // scaling constant for linking theta; only used in burn link
}
transformed parameters {
  ...
  for (r in 1:R) {
    ...
    reg[, r] = X_train_burn[r] * beta_burn[, r] + phi[2][idx_train_er, r] + gamma * theta[r];
  }
}
model {
  gamma ~ normal(0, 5);
...
generated quantities {
  ...
  for (r in 1:R) {
    reg_full[, r] = X_full_burn[r] * beta_burn[, r] + phi[2][, r] + gamma * theta[r];
  }
